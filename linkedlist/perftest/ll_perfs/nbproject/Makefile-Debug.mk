...
LDLIBSOPTIONS=`pkg-config --libs linkedlist` -lpthread  `pkg-config --libs cssmwide`  
...
${OBJECTDIR}/_ext/29dd86f/linkedlist.o: ../../linkedlist.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags linkedlist` `pkg-config --cflags cssmwide`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/linkedlist.o ../../linkedlist.c

${OBJECTDIR}/ll_perftests.o: ll_perftests.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags linkedlist` `pkg-config --cflags cssmwide`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ll_perftests.o ll_perftests.c
