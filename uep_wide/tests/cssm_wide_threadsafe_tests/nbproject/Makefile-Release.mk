...
${OBJECTDIR}/_ext/29dd86f/cssm_wide.o: ../../cssm_wide.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/cssm_wide.o ../../cssm_wide.c

${OBJECTDIR}/_ext/29dd86f/getElementEx.o: ../../getElementEx.c
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/getElementEx.o ../../getElementEx.c

${OBJECTDIR}/_ext/29dd86f/getPIDByName.o: ../../getPIDByName.c
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/getPIDByName.o ../../getPIDByName.c

${OBJECTDIR}/_ext/29dd86f/setElementEx.o: ../../setElementEx.c
	${MKDIR} -p ${OBJECTDIR}/_ext/29dd86f
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/29dd86f/setElementEx.o ../../setElementEx.c

${OBJECTDIR}/cw_threadsafetest.o: cw_threadsafetest.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cw_threadsafetest.o cw_threadsafetest.c
