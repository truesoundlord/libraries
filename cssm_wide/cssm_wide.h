...
#define bool bool
#endif                                                                                                                                                          // ATTENTION !! Il faut que "cssm_wide.h" soit inclu AVANT tout header relatif à MySQL.
...
#include <pthread.h>
pthread_mutex_t fctcore_mtx_protection;                                                                                                                         /* mutex interne */
bool	fctcore_brunning; // =true;																																																																/* flag interne */
...
void InitCSSMWIDE(char*);																																		// Permet d'initialiser la librairie CSSM_WIDE
...
int DisplayAnimatedText(PositionCadre, char*,struct s_RGB,struct s_RGB);                              // Permet d'animer du texte à l'intérieur d'un "cadre" prédéfini...
...
int setElement(void*,int,int,int,int,int,int,void*);
